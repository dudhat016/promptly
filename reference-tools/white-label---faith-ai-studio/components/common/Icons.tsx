...
interface IconProps {
  name: 'chat' | 'create' | 'upload' | 'magic' | 'download' | 'user' | 'bot' | 'save' | 'delete' | 'regenerate' | 'book';
  className?: string;
}
...
export const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6' }) => {
  const icons: { [key in IconProps['name']]: React.ReactElement } = {
    ...
    bot: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a14.98 14.98 0 00-5.84-2.56m-2.73.19a14.98 14.98 0 00-5.84 2.56m14.42-2.56a14.98 14.98 0 00-14.42 0M12 10.5h0m-4.243 4.243l-3.182 3.182a1.5 1.5 0 002.121 2.121l3.182-3.182m5.02-5.02l3.182-3.182a1.5 1.5 0 00-2.121-2.121l-3.182 3.182M12 3v.01M16.5 4.5l.01.01M4.5 16.5l.01.01M8.25 6.75l.01.01M3.75 12h.01M12 21h.01M19.5 12h.01M18 9.75l.01.01M6 9.75l.01.01" />
      </svg>
    ),
    save: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
